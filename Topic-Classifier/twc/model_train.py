...
with open('testset.txt','w') as ff:
    print(test_set,file=ff)
...
with open('classifiers_results.txt', 'w') as ff:
    print("LinearSVC_classifier accuracy:", nltk.classify.accuracy(LinearSVC_classifier, test_set)*100, file=ff)
    print("NaiveBayes accuracy:", nltk.classify.accuracy(classifier, test_set)*100, file=ff)
    print("MNB_classifier accuracy:", nltk.classify.accuracy(MNB_classifier, test_set)*100, file=ff)
